...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { cargo: @contato.cargo, email: @contato.email, estado_id: @contato.estado_id, idade: @contato.idade, nome: @contato.nome } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { cargo: @contato.cargo, email: @contato.email, estado_id: @contato.estado_id, idade: @contato.idade, nome: @contato.nome } }
